...
type SortField = "implant_type" | "host_id" | "user" | "privilege" | "started_at"
type SortDirection = "asc" | "desc"

export default function ImplantsPage() {
  const { currentProject, addImplant, updateImplant, deleteImplant } = useProject()
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Manage implants in your project</p>
        </div>
          ...
          <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
            ...
            <DialogContent className="max-w-md">
              <DialogHeader>
                ...
                <DialogDescription>Add a new implant to your project</DialogDescription>
              </DialogHeader>
              <div className="grid gap-4 py-4">
                <div className="grid gap-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setNewImplant({ ...newImplant, host_id: value })}
                  >
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewImplant({ ...newImplant, implant_type: e.target.value })}
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewImplant({ ...newImplant, user: e.target.value })}
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewImplant({ ...newImplant, privilege: e.target.value })}
                ...
                <div className="grid gap-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setNewImplant({ ...newImplant, notes: e.target.value })}
      ...
      {sortedImplants.length === 0 ? (
        <div className="text-center py-10">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Add your first implant to get started.</p>
        </div>
      ) : viewMode === "card" ? (
          ...
          {sortedImplants.map((implant) => (
            <Card key={implant.implant_id}>
              <CardHeader>
                ...
                <CardDescription>Host: {getHostNameById(implant.host_id)}</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-muted-foreground">Started: {formatDate(implant.started_at)}</span>
                  </div>
                  {implant.notes && (
              ...
              <CardFooter className="flex justify-between">
                <Dialog
                  open={isEditOpen && editingImplant?.implant_id === implant.implant_id}
                  onOpenChange={(open) => {
                    setIsEditOpen(open)
                ...
                >
                  <DialogTrigger asChild onClick={() => setEditingImplant(implant)}>
                  ...
                  <DialogContent className="max-w-md">
                    <DialogHeader>
                      ...
                      <DialogDescription>Update implant details</DialogDescription>
                    </DialogHeader>
                    {editingImplant && (
                      <div className="grid gap-4 py-4">
                        <div className="grid gap-2">
                          ...
                          <Select
                            ...
                            onValueChange={(value) => setEditingImplant({ ...editingImplant, host_id: value })}
                          >
                        ...
                        <div className="grid gap-2">
                          <Label htmlFor="edit_implant_type">Implant Type</Label>
                          <Input
                            id="edit_implant_type"
                            value={editingImplant.implant_type}
                            onChange={(e) => setEditingImplant({ ...editingImplant, implant_type: e.target.value })}
                          />
                        </div>
                        <div className="grid gap-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => setEditingImplant({ ...editingImplant, user: e.target.value })}
                          />
                        </div>
                        <div className="grid gap-2">
                          <Label htmlFor="edit_privilege">Privilege Level</Label>
                          <Input
                            id="edit_privilege"
                            value={editingImplant.privilege}
                            onChange={(e) => setEditingImplant({ ...editingImplant, privilege: e.target.value })}
                          />
                        </div>
                        <div className="grid gap-2">
                    ...
                    <DialogFooter>
                      ...
                      <Button onClick={handleUpdateImplant}>Update Implant</Button>
                    </DialogFooter>
                  </DialogContent>
                </Dialog>
                ...
                >
                  <DialogTrigger asChild onClick={() => setImplantToDelete(implant.implant_id)}>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Are you sure you want to delete this implant? This action cannot be undone.
                      </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                      <Button
                      ...
                      <Button variant="destructive" onClick={handleDeleteImplant}>
                        Delete Implant
                      </Button>
                    </DialogFooter>
                  </DialogContent>
        ...
        <div className="rounded-md border">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="cursor-pointer" onClick={() => handleSort("implant_type")}>
                  <div className="flex items-center">Implant Type {getSortIcon("implant_type")}</div>
                </TableHead>
                <TableHead className="cursor-pointer" onClick={() => handleSort("host_id")}>
                  <div className="flex items-center">Host {getSortIcon("host_id")}</div>
                </TableHead>
                <TableHead className="cursor-pointer" onClick={() => handleSort("user")}>
                  <div className="flex items-center">User {getSortIcon("user")}</div>
                </TableHead>
                <TableHead className="cursor-pointer" onClick={() => handleSort("privilege")}>
                  <div className="flex items-center">Privilege {getSortIcon("privilege")}</div>
                </TableHead>
                <TableHead className="cursor-pointer" onClick={() => handleSort("started_at")}>
                  <div className="flex items-center">Started At {getSortIcon("started_at")}</div>
                </TableHead>
            ...
            <TableBody>
              {sortedImplants.map((implant) => (
                <TableRow key={implant.implant_id}>
                  <TableCell className="font-medium">{implant.implant_type}</TableCell>
                  ...
                  <TableCell className="max-w-[200px] truncate">{implant.notes}</TableCell>
                  <TableCell>
                    <div className="flex gap-2">
                      <Dialog
                        open={isEditOpen && editingImplant?.implant_id === implant.implant_id}
