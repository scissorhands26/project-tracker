...
export type Status = "discovered" | "scanning" | "vulnerable" | "exploited" | "completed"
...
export function ProjectProvider({ children }: { children: ReactNode }) {
  ...
  const deleteProject = (projectId: string) => {
    ...
    if (currentProject?.project_id === projectId) {
      setCurrentProject(projects.length > 1 ? projects.find((p) => p.project_id !== projectId) || null : null)
    }
  }
  ...
  const updateNetwork = (updatedNetwork: Network) => {
    ...
    const updatedProject = {
      ...currentProject,
      networks: currentProject.networks.map((n) => (n.network_id === updatedNetwork.network_id ? updatedNetwork : n)),
    }
  ...
  const deleteNetwork = (networkId: string) => {
    ...
    const updatedProject = {
      ...currentProject,
      networks: currentProject.networks.filter((n) => n.network_id !== networkId),
    }
  ...
  const updateHost = (updatedHost: Host) => {
    ...
    const updatedProject = {
      ...currentProject,
      hosts: currentProject.hosts.map((h) => (h.host_id === updatedHost.host_id ? updatedHost : h)),
    }
  ...
  const updateExploit = (updatedExploit: Exploit) => {
    ...
    const updatedProject = {
      ...currentProject,
      exploits: currentProject.exploits.map((e) => (e.exploit_id === updatedExploit.exploit_id ? updatedExploit : e)),
    }
  ...
  const deleteExploit = (exploitId: string) => {
    ...
    const updatedProject = {
      ...currentProject,
      exploits: currentProject.exploits.filter((e) => e.exploit_id !== exploitId),
    }
  ...
  const deleteCredential = (credentialId: string) => {
    ...
    const updatedProject = {
      ...currentProject,
      credentials: currentProject.credentials.filter((c) => c.cred_id !== credentialId),
    }
  ...
  const updateImplant = (updatedImplant: Implant) => {
    ...
    const updatedProject = {
      ...currentProject,
      implants: currentProject.implants.map((i) => (i.implant_id === updatedImplant.implant_id ? updatedImplant : i)),
    }
  ...
  const deleteImplant = (implantId: string) => {
    ...
    const updatedProject = {
      ...currentProject,
      implants: currentProject.implants.filter((i) => i.implant_id !== implantId),
    }
  ...
  const deleteNetworkDevice = (deviceId: string) => {
    ...
    const updatedProject = {
      ...currentProject,
      network_devices: currentProject.network_devices.filter((d) => d.device_id !== deviceId),
    }
  ...
  const importData = (jsonData: string) => {
    try {
      ...
      const existingProject = projects.find((p) => p.project_id === importedProject.project_id)
    ...
    <ProjectContext.Provider
      value={{
        ...
        loadSampleData: () => {
          ...
          // Check if project already exists
          const existingProject = projects.find((p) => p.project_id === sampleProject.project_id)
